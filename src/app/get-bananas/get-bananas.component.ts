...
@Component({
  ...
  <div *ngIf="results" class="row">
    <div class="col s12">
      ...
      <h4 class="deep-orange-text text-darken-2">To confirm, this is the information we have received. Your first name is "ben", your last name is "lesh", and your email is "ben@ben.com"</h4>
